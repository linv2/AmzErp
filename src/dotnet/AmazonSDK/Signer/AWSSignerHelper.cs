...
namespace AmazonSDK.Signer
{
    ...
    public class AWSSignerHelper
    {
        ...
        public virtual DateTime InitializeHeaders(IRestRequest restRequest, string host, string accessToken)
        {
            ...
            restRequest.AddHeader("user-agent", "RestSharp/106.11.8.0");
